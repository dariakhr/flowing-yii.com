          ...
          <div class="col-xs-12">
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="backcall">
                ...
                <?php $my_form = ActiveForm::begin(['action' => ['recalls/create'], 'id' => 'recalls_form', 'method' => 'get',]); ?>
                <label for="call">Обраный звонок:</label>
                <?= $my_form -> field($model, 'phone_number'); ?>
                <?=HTML::submitButton('Create', ['class' => 'recalls-js'])?>
